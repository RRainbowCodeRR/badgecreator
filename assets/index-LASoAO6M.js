...
A.setToSJISFunction = function (t) {
...
V.prototype.set = function (e, t, i, r) {
...
var vt = V,
  pt = {};
(function (e) {
  const t = A.getSymbolSize;
  (e.getRowColCoords = function (r) {
    if (r === 1) return [];
    const n = Math.floor(r / 7) + 2,
      o = t(r),
      s = o === 145 ? 26 : Math.ceil((o - 13) / (2 * n - 2)) * 2,
      c = [o - 7];
...
(function (e) {
  ...
  (e.isValid = function (n) {
    ...
    (e.getPenaltyN1 = function (n) {
      ...
      for (let C = 0; C < o; C++) {
        ...
        for (let m = 0; m < o; m++) {
          let f = n.get(C, m);
          f === u ? c++ : (c >= 5 && (s += t.N1 + (c - 5)), (u = f), (c = 1)),
            (f = n.get(m, C)),
            f === l ? a++ : (a >= 5 && (s += t.N1 + (a - 5)), (l = f), (a = 1));
        }
    ...
    (e.getPenaltyN3 = function (n) {
      ...
      for (let u = 0; u < o; u++) {
        c = a = 0;
        for (let l = 0; l < o; l++)
          (c = ((c << 1) & 2047) | n.get(u, l)),
            l >= 10 && (c === 1488 || c === 93) && s++,
            (a = ((a << 1) & 2047) | n.get(l, u)),
            l >= 10 && (a === 1488 || a === 93) && s++;
      }
      return s * t.N3;
    }),
  ...
  (e.applyMask = function (n, o) {
    const s = o.size;
    for (let c = 0; c < s; c++)
      for (let a = 0; a < s; a++) o.isReserved(a, c) || o.xor(a, c, i(n, a, c));
  }),
...
(function (e) {
  ...
  (e.mul = function (r, n) {
    ...
    for (let s = 0; s < r.length; s++)
      for (let c = 0; c < n.length; c++) o[s + c] ^= t.mul(r[s], n[c]);
    return o;
  }),
    (e.mod = function (r, n) {
...
st.prototype.initialize = function (t) {
  (this.degree = t), (this.genPoly = It.generateECPolynomial(this.degree));
};
st.prototype.encode = function (t) {
  if (!this.genPoly) throw new Error("Encoder not initialized");
  const i = new Uint8Array(t.length + this.degree);
  i.set(t);
  const r = It.mod(i, this.genPoly),
...
T.KANJI = new RegExp(z, "g");
T.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g");
T.BYTE = new RegExp(Kt, "g");
T.NUMERIC = new RegExp(At, "g");
T.ALPHANUMERIC = new RegExp(zt, "g");
const Vt = new RegExp("^" + z + "$"),
  Ht = new RegExp("^" + At + "$"),
  Ot = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
(function (e) {
  ...
  (e.NUMERIC = { id: "Numeric", bit: 1, ccBits: [10, 12, 14] }),
    ...
    (e.getBestModeForData = function (o) {
      return i.testNumeric(o)
        ? e.NUMERIC
        : i.testAlphanumeric(o)
        ? e.ALPHANUMERIC
        : i.testKanji(o)
        ? e.KANJI
        : e.BYTE;
...
(function (e) {
  const t = A,
    ...
    c = t.getBCHDigit(s);
  function a(m, f, w) {
    for (let y = 1; y <= 40; y++) if (f <= e.getCapacity(y, w, m)) return y;
  }
  function u(m, f) {
  ...
  function C(m, f) {
    for (let w = 1; w <= 40; w++)
      if (l(m, w) <= e.getCapacity(w, f, n.MIXED)) return w;
  }
  (e.from = function (f, w) {
    ...
    (e.getCapacity = function (f, w, y) {
      ...
      typeof y > "u" && (y = n.BYTE);
      const b = t.getSymbolTotalCodewords(f),
        h = i.getTotalCodewordsCount(f, w),
        p = (b - h) * 8;
      if (y === n.MIXED) return p;
      const g = p - u(y, f);
      switch (y) {
        case n.NUMERIC:
    ...
    (e.getBestVersionForData = function (f, w) {
      ...
      if (Array.isArray(f)) {
        if (f.length > 1) return C(f, b);
        if (f.length === 0) return 1;
        y = f[0];
      } else y = f;
      return a(y.mode, y.getLength(), b);
    }),
    (e.getEncodedBits = function (f) {
      if (!o.isValid(f) || f < 7) throw new Error("Invalid QR Code version");
      let w = f << 12;
      for (; t.getBCHDigit(w) - c >= 0; ) w ^= s << (t.getBCHDigit(w) - c);
      return (f << 12) | w;
    });
})(bt);
var Nt = {};
const et = A,
  Pt = 1335,
  Jt = 21522,
  ft = et.getBCHDigit(Pt);
Nt.getEncodedBits = function (t, i) {
  const r = (t.bit << 3) | i;
  let n = r << 10;
  for (; et.getBCHDigit(n) - ft >= 0; ) n ^= Pt << (et.getBCHDigit(n) - ft);
  return ((r << 10) | n) ^ Jt;
};
var Tt = {};
const Qt = L;
...
D.prototype.write = function (t) {
  ...
  o > 0 &&
    ((r = this.data.substr(i)), (n = parseInt(r, 10)), t.put(n, o * 3 + 1));
};
var Yt = D;
const $t = L,
  W = [
...
(function (e) {
  var t = {
    single_source_shortest_paths: function (i, r, n) {
      ...
      c.push(r, 0);
      for (var a, u, l, C, m, f, w, y, b; !c.empty(); ) {
        (a = c.pop()), (u = a.value), (C = a.cost), (m = i[u] || {});
        for (l in m)
          m.hasOwnProperty(l) &&
            ((f = m[l]),
            (w = C + f),
...
(function (e) {
  ...
  function C(h) {
    const p = l(s.NUMERIC, t.NUMERIC, h),
      g = l(s.ALPHANUMERIC, t.ALPHANUMERIC, h);
    let d, E;
    return (
      c.isKanjiModeEnabled()
        ? ((d = l(s.BYTE, t.BYTE, h)), (E = l(s.KANJI, t.KANJI, h)))
        : ((d = l(s.BYTE_KANJI, t.BYTE, h)), (E = [])),
      p
        .concat(g, d, E)
        .sort(function (I, N) {
  ...
  function f(h) {
    return h.reduce(function (p, g) {
      ...
      return d && d.mode === g.mode
        ? ((p[p.length - 1].data += g.data), p)
        : (p.push(g), p);
    }, []);
  }
  function w(h) {
    ...
    for (let g = 0; g < h.length; g++) {
      ...
      switch (d.mode) {
        case t.NUMERIC:
          ...
          break;
        case t.ALPHANUMERIC:
          p.push([d, { data: d.data, mode: t.BYTE, length: d.length }]);
          break;
        case t.KANJI:
          p.push([d, { data: d.data, mode: t.BYTE, length: u(d.data) }]);
          break;
        case t.BYTE:
          p.push([{ data: d.data, mode: t.BYTE, length: u(d.data) }]);
      }
    }
    return p;
  }
  function y(h, p) {
    ...
    for (let B = 0; B < h.length; B++) {
      ...
      for (let R = 0; R < I.length; R++) {
        const P = I[R],
          k = "" + B + R;
        N.push(k), (g[k] = { node: P, lastCount: 0 }), (d[k] = {});
        for (let G = 0; G < E.length; G++) {
          const M = E[G];
          g[M] && g[M].node.mode === P.mode
            ? ((d[M][k] =
                m(g[M].lastCount + P.length, P.mode) -
                m(g[M].lastCount, P.mode)),
              (g[M].lastCount += P.length))
            : (g[M] && (g[M].lastCount = P.length),
              (d[M][k] =
                m(P.length, P.mode) + 4 + t.getCharCountIndicator(P.mode, p)));
        }
      }
      E = N;
    }
    for (let B = 0; B < E.length; B++) d[E[B]].end = 0;
    return { map: d, table: g };
  }
  function b(h, p) {
    let g;
    const d = t.getBestModeForData(h);
    if (((g = t.from(p, d)), g !== t.BYTE && g.bit < d.bit))
      throw new Error(
        '"' +
          h +
  ...
  (e.fromArray = function (p) {
    return p.reduce(function (g, d) {
      return (
        typeof d == "string"
          ? g.push(b(d, null))
          : d.data && g.push(b(d.data, d.mode)),
        g
      );
    }, []);
  }),
    (e.fromString = function (p, g) {
      const d = C(p, c.isKanjiModeEnabled()),
        E = w(d),
        B = y(E, g),
        I = a.find_path(B.map, "start", "end"),
        N = [];
      for (let R = 1; R < I.length - 1; R++) N.push(B.table[I[R]].node);
      return e.fromArray(f(N));
    }),
    (e.rawSplit = function (p) {
      return e.fromArray(C(p, c.isKanjiModeEnabled()));
    });
})(Tt);
const q = A,
  Z = Y,
...
function de(e, t, i) {
  ...
  i.forEach(function (a) {
    r.put(a.mode.bit, 4),
      r.put(a.getLength(), se.getCharCountIndicator(a.mode, e)),
      a.write(r);
  });
  const n = q.getSymbolTotalCodewords(e),
    o = ot.getTotalCodewordsCount(e, t),
    s = (n - o) * 8;
  for (
...
function ge(e, t, i) {
  const r = q.getSymbolTotalCodewords(t),
    n = ot.getTotalCodewordsCount(t, i),
    o = r - n,
    s = ot.getBlocksCount(t, i),
    c = r % s,
    a = s - c,
    u = Math.floor(r / s),
    l = Math.floor(o / s),
  ...
  let d = 0,
    ...
    B;
  for (E = 0; E < h; E++)
    for (B = 0; B < s; B++) E < y[B].length && (g[d++] = y[B][E]);
  for (E = 0; E < m; E++) for (B = 0; B < s; B++) g[d++] = b[B][E];
  return g;
}
function he(e, t, i, r) {
  let n;
  if (Array.isArray(e)) n = X.fromArray(e);
    ...
    n = X.fromString(e, u || 40);
  } else throw new Error("Invalid data");
  const o = Q.getBestVersionForData(n, i);
  if (!o)
...
`
  ...
  return (
    ...
    t >= 7 && le(a, t),
    fe(a, s),
    isNaN(r) && (r = nt.getBestMask(a, x.bind(null, a, i))),
    nt.applyMask(r, a),
    x(a, i, r),
    {
      modules: a,
...
wt.create = function (t, i) {
  ...
  return (
    typeof i < "u" &&
      ((r = Z.from(i.errorCorrectionLevel, Z.M)),
      (n = Q.from(i.version)),
      (o = nt.from(i.maskPattern)),
...
(function (e) {
  ...
  (e.getOptions = function (r) {
    ...
    (e.getScale = function (r, n) {
      return n.width && n.width >= r + n.margin * 2
        ? n.width / (r + n.margin * 2)
        : n.scale;
    }),
...
(function (e) {
  ...
  (e.render = function (o, s, c) {
    ...
    typeof a > "u" && (!s || !s.getContext) && ((a = s), (s = void 0)),
      s || (u = r()),
      (a = t.getOptions(a));
    const l = t.getImageWidth(o.modules.size, a),
      C = u.getContext("2d"),
      m = C.createImageData(l, l);
    return (
      t.qrToImageData(m.data, o, a), i(C, u, l), C.putImageData(m, 0, 0), u
    );
  }),
    (e.renderToDataURL = function (o, s, c) {
      ...
      typeof a > "u" && (!s || !s.getContext) && ((a = s), (s = void 0)),
        a || (a = {});
      const u = e.render(o, s, a),
        l = a.type || "image/png",
        C = a.rendererOpts || {};
      return u.toDataURL(l, C.quality);
    });
})(Rt);
var St = {};
const me = ct;
  ...
  for (let c = 0; c < e.length; c++) {
    ...
    !a && !o && (o = !0),
      e[c]
        ? (s++,
          (c > 0 && a > 0 && e[c - 1]) ||
            ((r += o ? tt("M", a + i, 0.5 + u + i) : tt("m", n, 0)),
            (n = 0),
            (o = !1)),
          (a + 1 < t && e[c + 1]) || ((r += tt("h", s)), (s = 0)))
        : n++;
  }
  return r;
}
St.render = function (t, i, r) {
  const n = me.getOptions(i),
    o = t.modules.size,
    s = t.modules.data,
    c = o + n.margin * 2,
    a = n.color.light.a
...
function ut(e, t, i, r, n) {
  const o = [].slice.call(arguments, 1),
    s = o.length,
    c = typeof o[s - 1] == "function";
  if (!c && !ye()) throw new Error("Callback required as last argument");
  if (c) {
    ...
    s === 2
      ...
      : s === 3 &&
        (t.getContext && typeof n > "u"
          ? ((n = r), (r = void 0))
          : ((n = r), (r = i), (i = t), (t = void 0)));
  } else {
    if (s < 1) throw new Error("Too few arguments provided");
    return (
      s === 1
        ? ((i = t), (t = r = void 0))
        : s === 2 && !t.getContext && ((r = i), (i = t), (t = void 0)),
      new Promise(function (a, u) {
        try {
          const l = rt.create(i, r);
          a(e(l, t, r));
        } catch (l) {
          u(l);
        }
...
K.create = rt.create;
K.toCanvas = ut.bind(null, Lt.render);
K.toDataURL = ut.bind(null, Lt.renderToDataURL);
K.toString = ut.bind(null, function (e, t, i) {
  return pe.render(e, i);
});
const Ee = document.getElementById("frontCanvas"),
  Ce = document.getElementById("backCanvas"),
  gt = document.getElementById("nameInput"),
  Be = document.getElementById("userIDInput"),
  Ie = document.getElementById("passwordInput");
async function ht(e, t) {
  try {
    await K.toCanvas(t, e, {
      width: 128,
      margin: 2,
    ...
    throw (console.error("Error generating QR code:", i), i);
  }
}
async function be() {
  const e = Be.value,
  ...
  try {
    await ht(e, Ee), await ht(t, Ce);
    const i = document.getElementById("displayName");
    i && gt.value && (i.textContent = gt.value);
  } catch (i) {
    console.error("Error updating QR codes:", i),
      alert("Error generating QR codes. Please try again.");
  }
}
var mt;
(mt = document.getElementById("generateButton")) == null ||
  mt.addEventListener("click", be);
function Ae() {
  const e = window.open("", "_blank"),
    t = document.getElementById("frontCanvas").toDataURL(),
    i = document.getElementById("backCanvas").toDataURL(),
    r = document.getElementById("displayName").textContent,
    n = `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
            <div class="card">
                ...
                <img src="${t}" class="qr-image" alt="Front QR Code">
            ...
            <div class="card">
                <div class="name">${r}</div>
                <img src="${i}" class="qr-image" alt="Back QR Code">
...
document.addEventListener("DOMContentLoaded", () => {
  const e = document.querySelector(".input-group"),
    t = document.createElement("button");
  (t.textContent = "Print Badges"),
    (t.style.margin = "auto"),
...
//# sourceMappingURL=index-LASoAO6M.js.map
